...
| Sem.18  | CDC V1      |         https://github.com/IUT-Blagnac/sae2-01-devapp-2024-sae-4b1/blob/main/CDC_V1.adoc nous n'avons pas eu le temps d'ajouter le JAR à notre CDC                          |           
|         |Gantt V1 Prévu|        https://github.com/IUT-Blagnac/sae2-01-devapp-2024-sae-4b1/blob/main/GANTT_V1_SAEP.png                          |
| 07/05  | CdC V2final|                                     |  
|         | Doc. Tec. V0 |        |    
|         | Doc User V0    |        |
|         | Recette V0  |                      | 
